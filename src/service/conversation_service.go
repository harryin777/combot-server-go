...
func (s *ConversationServiceImpl) SaveConversation(ctx context.Context,
	sessionID, deviceID, clientID string, userID int, message string, role, messageType int, combotName string) error {
...
func (s *ConversationServiceImpl) GetUserConversations(ctx context.Context, userID uint, deviceID string, limit int, offset int) ([]models.ConversationSession, error) {
...
func (s *ConversationServiceImpl) GetConversationMessages(ctx context.Context, sessionID string, limit int, offset int) ([]models.ConversationMessage, error) {
